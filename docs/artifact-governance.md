...
- `docs/live-contracts.md`: user-facing Live workflow vocabulary, Core-owned
  source-refresh scheduling boundary, config contract, trigger ids, bounded read
  model, and Dashboard navigation language.

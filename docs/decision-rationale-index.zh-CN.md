...
| 自然时间主要提高冻结构建的运行证据，不会自动提高独立后续切片的实现正确性；以有界短时门继续建设、以完整长期观察约束发布和真实资金使用，既保留反馈速度，也不降低真实动作门槛 | [HALPHA-ENG-001](L2/HALPHA-ENG-001-ai-development-and-engineering-quality.zh-CN.md) | [5.2 分离建设等待与真实使用门的选择依据【ENG-OBS-001-RAT】](L2/HALPHA-ENG-001-ai-development-and-engineering-quality.zh-CN.md#52-分离建设等待与真实使用门的选择依据eng-obs-001-rat) |
...
| 当前采用 8 小时正常建设阻塞预算和 24 小时绝对上限，完整保留 72 小时 Windows 与 7–14 日 LIVE_READ_ONLY 观察；短时门只服务另行授权的建设继续，长期证据继续服务发布与真实资金资格 | [HALPHA-PLAN-001](L4/HALPHA-PLAN-001-current-construction-plan.yaml) | [construction_packages.B04.construction_continuation_gate / long_observation](L4/HALPHA-PLAN-001-current-construction-plan.yaml) |

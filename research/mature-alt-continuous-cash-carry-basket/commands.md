...
```powershell
$q = 'research/mature-alt-continuous-cash-carry-basket'
...
$historicalManifest = 'research/multi-asset-persistent-funding-carry/source_manifest_development_backfilled.json'
...
```powershell
python research/multi-asset-persistent-funding-carry/study.py fetch --cache-dir $confirmationCache --universe core --start-month 2024-01 --end-month 2025-09 --manifest "$q/source_manifest_confirmation.json"
```

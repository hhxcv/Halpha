"""Rebuild the historical ParquetDataCatalog from verified Binance archives."""
...
DATASET_ID = "btcusdt-1m-2022-01_2026-06"
RAW_ROOT = ROOT / "build" / "evidence" / "raw" / DATASET_ID
CATALOG_ROOT = ROOT / "build" / "evidence" / "catalog" / DATASET_ID
PREREGISTRATION_PATH = ROOT / "build" / "evidence" / "reports" / "historical-research-question.json"
DATA_EVIDENCE_PATH = ROOT / "build" / "qualification" / "historical-data.json"
CATALOG_EVIDENCE_PATH = ROOT / "build" / "qualification" / "historical-catalog.json"
...
class HistoricalCatalogError(RuntimeError):
    """Sanitized historical catalog failure."""
...
def main() -> int:
    ...
    try:
        ...
        evidence: dict[str, Any] = {
            "schema_version": 1,
            "operation": "HISTORICAL_PARQUET_CATALOG",
            "status": "QUALIFIED",

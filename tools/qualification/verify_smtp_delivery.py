...
DEFAULT_OUTPUT = ROOT / "build/qualification/smtp-delivery.json"
...
def verify(
    ...
    *,
        ...
        try:
            ...
            StdlibSMTPTransport(settings.email, smtp_password).send(
                ...
                content=NotificationContent(
                    subject="Halpha SMTP direct check",
                    body=(
                        "Halpha SMTP direct check message.\n"
    ...
    evidence: dict[str, Any] = {
        "schema_version": 1,
        "operation": "ACTUAL_SMTP_DELIVERY",
        ...
        "source_sha256": {
            ...
            "tools/qualification/verify_smtp_delivery.py": _sha256_file(
                root / "tools/qualification/verify_smtp_delivery.py"
            ),
        },
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if not output.is_relative_to(root):
        raise RuntimeError("SMTP_OUTPUT_OUTSIDE_REPOSITORY")

...
STAGE_OUTPUTS = {
    ...
    "collect_market_anomalies_data": ("raw/market_anomalies.json",),
    "sync_market_anomaly_history": (
...
STAGE_ENABLED_CONDITIONS = {
    ...
    "collect_market_anomalies_data": "market.anomalies.enabled",
...
OPERATION_DEPENDENCIES = {
    ...
    "collect_text_events": (),
    "sync_ohlcv": (),
    "collect_market_anomalies_data": ("sync_ohlcv",),
    "sync_market_anomaly_history": ("collect_market_anomalies_data",),
    "build_derivatives_market_views": (
        "collect_derivatives_market_data",
        "sync_derivatives_market_history",
    ),

...
def render_prompt(context: str, *, report_title: str, generated_at: str) -> str:
    return "\n".join(
        [
            ...
            "37. When factor/signal material is present, explain Halpha-generated feature, factor, and multi-source signal evidence where it affects interpretation, synthesis, watch points, or risk notes.",
            "38. Use only Halpha-generated feature records, factor states, factor scores, and multi-source signal states from the factor/signal material.",
            "39. Do not generate or revise feature records, factor scores, factor states, signal states, action levels, price forecasts, trading advice, position sizing, or account actions.",
            "40. When intelligence fusion material is present, explain Halpha-generated confluence, conflict, risk override, event override, outcome feedback, and uncertainty where supported.",
            "41. Use only Halpha-generated fusion states, risk override states, event override states, outcome feedback states, and source refs from the fusion material.",
            "42. Do not generate or revise fusion states, risk overrides, event overrides, alert priorities, action levels, price forecasts, trading advice, position sizing, or account actions.",
            "43. When personalized risk material is present, distinguish general intelligence from Halpha-generated personalized constraints.",
            "44. Use only Halpha-generated personalized constraint states, actions, reason codes, evidence, and uncertainty from personalized risk material.",
            "45. Do not infer hidden user state, holdings, allocations, account state, or unstated preferences from personalized material.",
            "46. Do not generate or revise personalized constraints, action levels, alert priorities, position sizing, price forecasts, trading advice, or account actions.",
            "47. When event intelligence material is present, explain Halpha-generated event evidence, topic grouping, source coverage, recency, uncertainty, and event-quant confluence or conflict where supported.",
            "48. Use only Halpha-generated event categories, event signals, event impacts, and event-market relationships from the event intelligence material.",
            "49. Do not generate or revise event classifications, event impacts, event-market relationships, action levels, price forecasts, trading advice, position sizing, or account actions.",
            "50. Treat unknown, low-confidence, skipped, degraded, conflicting, or insufficient event evidence conservatively.",
            "51. Treat financial tone as event-text evidence only, not as a trading signal or price forecast.",
            "52. When alert decision material is present, explain Halpha-generated P0, P1, P2, P3, and no-alert states where supported.",
            "53. Use only Halpha-generated alert priority, event severity, decision impact, downgrade reasons, suppression reasons, and uncertainty from the alert decision material.",
            "54. Do not generate or revise alert priority, event severity, decision impact, action levels, alert delivery, price forecasts, trading advice, position sizing, or account actions.",
            "55. When data quality material is present, explain Halpha-generated quality status only where it affects interpretation.",
            "56. Do not generate or revise data-quality checks, validation results, store contents, catalog contents, run-index contents, raw archive contents, or reusable history records.",
            "57. When outcome tracking material is present, explain Halpha-generated outcome states only as accountability evidence.",
            "58. Do not create outcome labels, validate missing histories, infer omitted outcome stores, score prior recommendations independently, or rank strategies from outcomes.",
            "",

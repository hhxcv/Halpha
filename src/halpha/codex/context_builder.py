...
def render_prompt(context: str, *, report_title: str, generated_at: str) -> str:
    return "\n".join(
        [
            ...
            "40. When event intelligence material is present, explain Halpha-generated event evidence, topic grouping, source coverage, recency, uncertainty, and event-quant confluence or conflict where supported.",
            "41. Use only Halpha-generated event categories, event signals, event impacts, and event-market relationships from the event intelligence material.",
            "42. Do not generate or revise event classifications, event impacts, event-market relationships, action levels, price forecasts, trading advice, position sizing, or account actions.",
            "43. Treat unknown, low-confidence, skipped, degraded, conflicting, or insufficient event evidence conservatively.",
            "44. Treat financial tone as event-text evidence only, not as a trading signal or price forecast.",
            "45. When alert decision material is present, explain Halpha-generated P0, P1, P2, P3, and no-alert states where supported.",
            "46. Use only Halpha-generated alert priority, event severity, decision impact, downgrade reasons, suppression reasons, and uncertainty from the alert decision material.",
            "47. Do not generate or revise alert priority, event severity, decision impact, action levels, alert delivery, price forecasts, trading advice, position sizing, or account actions.",
            "48. When data quality material is present, explain Halpha-generated quality status only where it affects interpretation.",
            "49. Do not generate or revise data-quality checks, validation results, store contents, catalog contents, run-index contents, raw archive contents, or reusable history records.",
            "50. When outcome tracking material is present, explain Halpha-generated outcome states only as accountability evidence.",
            "51. Do not create outcome labels, validate missing histories, infer omitted outcome stores, score prior recommendations independently, or rank strategies from outcomes.",
            "",

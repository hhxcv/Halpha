...
def render_prompt(context: str, *, report_title: str, generated_at: str) -> str:
    return "\n".join(
        [
            ...
            "37. When strategy lifecycle material is present, explain Halpha-generated strategy lifecycle health, degradation, watchlist, rejection, retirement, insufficient evidence, source availability, and omitted-record counts where relevant.",
            "38. Use only Halpha-generated lifecycle statuses, health states, parameter digests, strategy versions, policy refs, and source refs from lifecycle material.",
            "39. Do not generate or revise lifecycle states, strategy versions, parameter digests, policy records, promotion decisions, retirement decisions, parameter optimization, strategy selection, price forecasts, trading advice, position sizing, or account actions.",
            "40. When factor/signal material is present, explain Halpha-generated feature, factor, and multi-source signal evidence where it affects interpretation, synthesis, watch points, or risk notes.",
            "41. Use only Halpha-generated feature records, factor states, factor scores, and multi-source signal states from the factor/signal material.",
            "42. Do not generate or revise feature records, factor scores, factor states, signal states, action levels, price forecasts, trading advice, position sizing, or account actions.",
            "43. When intelligence fusion material is present, explain Halpha-generated confluence, conflict, risk override, event override, outcome feedback, and uncertainty where supported.",
            "44. Use only Halpha-generated fusion states, risk override states, event override states, outcome feedback states, and source refs from the fusion material.",
            "45. Do not generate or revise fusion states, risk overrides, event overrides, alert priorities, action levels, price forecasts, trading advice, position sizing, or account actions.",
            "46. When personalized risk material is present, distinguish general intelligence from Halpha-generated personalized constraints.",
            "47. Use only Halpha-generated personalized constraint states, actions, reason codes, evidence, and uncertainty from personalized risk material.",
            "48. Do not infer hidden user state, holdings, allocations, account state, or unstated preferences from personalized material.",
            "49. Do not generate or revise personalized constraints, action levels, alert priorities, position sizing, price forecasts, trading advice, or account actions.",
            "50. When event intelligence material is present, explain Halpha-generated event evidence, topic grouping, source coverage, recency, uncertainty, and event-quant confluence or conflict where supported.",
            "51. Use only Halpha-generated event categories, event signals, event impacts, and event-market relationships from the event intelligence material.",
            "52. Do not generate or revise event classifications, event impacts, event-market relationships, action levels, price forecasts, trading advice, position sizing, or account actions.",
            "53. Treat unknown, low-confidence, skipped, degraded, conflicting, or insufficient event evidence conservatively.",
            "54. Treat financial tone as event-text evidence only, not as a trading signal or price forecast.",
            "55. When alert decision material is present, explain Halpha-generated P0, P1, P2, P3, and no-alert states where supported.",
            "56. Use only Halpha-generated alert priority, event severity, decision impact, downgrade reasons, suppression reasons, and uncertainty from the alert decision material.",
            "57. Do not generate or revise alert priority, event severity, decision impact, action levels, alert delivery, price forecasts, trading advice, position sizing, or account actions.",
            "58. When data quality material is present, explain Halpha-generated quality status only where it affects interpretation.",
            "59. Do not generate or revise data-quality checks, validation results, store contents, catalog contents, run-index contents, raw archive contents, or reusable history records.",
            "60. When outcome tracking material is present, explain Halpha-generated outcome states only as accountability evidence.",
            "61. Do not create outcome labels, validate missing histories, infer omitted outcome stores, score prior recommendations independently, or rank strategies from outcomes.",
            "",

...
def render_prompt(context: str, *, report_title: str, generated_at: str) -> str:
    return "\n".join(
        [
            ...
            "24. When decision intelligence material is present, use it for action-facing decision language and use quantitative material as upstream evidence.",
            "25. Include supported decision coverage for current decision view, what to do, what not to do, tentative opportunities, wait/watch conditions, risk state, invalidation conditions, changes versus previous run, uncertainty, and method limits.",
            "26. Do not invent action levels, signals, prices, strategy conclusions, unsupported trading instructions, or stronger advice than the decision material supports.",
            "27. Do not upgrade WATCH, NO_ACTION, low-confidence, high-risk, conflicting, or insufficient-evidence material into stronger action language.",
            "28. When strategy experiment material is present, identify effective, watchlisted, rejected, and insufficient-evidence strategy candidates from Halpha gate outcomes.",
            "29. Explain benchmark coverage, costs, sample limits, walk-forward evidence, overfitting checks, and uncertainty near strategy effectiveness statements.",
            "30. Do not generate or revise strategy gate statuses, reasons, metrics, or promotion decisions.",
            "31. When event intelligence material is present, explain Halpha-generated event evidence, topic grouping, source coverage, recency, uncertainty, and event-quant confluence or conflict where supported.",
            "32. Use only Halpha-generated event categories, event signals, event impacts, and event-market relationships from the event intelligence material.",
            "33. Do not generate or revise event classifications, event impacts, event-market relationships, action levels, price forecasts, trading advice, position sizing, or account actions.",
            "34. Treat unknown, low-confidence, skipped, degraded, conflicting, or insufficient event evidence conservatively.",
            "35. Treat financial tone as event-text evidence only, not as a trading signal or price forecast.",
            "36. When alert decision material is present, explain Halpha-generated P0, P1, P2, P3, and no-alert states where supported.",
            "37. Use only Halpha-generated alert priority, event severity, decision impact, downgrade reasons, suppression reasons, and uncertainty from the alert decision material.",
            "38. Do not generate or revise alert priority, event severity, decision impact, action levels, alert delivery, price forecasts, trading advice, position sizing, or account actions.",
            "39. When data quality material is present, explain Halpha-generated quality status only where it affects interpretation.",
            "40. Do not generate or revise data-quality checks, validation results, store contents, catalog contents, run-index contents, raw archive contents, or reusable history records.",
            "41. When outcome tracking material is present, explain Halpha-generated outcome states only as accountability evidence.",
            "42. Do not create outcome labels, validate missing histories, infer omitted outcome stores, score prior recommendations independently, or rank strategies from outcomes.",
            "",

...
def _stage_handlers(overrides: dict[str, StageHandler] | None = None) -> dict[str, StageHandler]:
    ...
    handlers["build_onchain_flow_material"] = _build_onchain_flow_material
    ...
    handlers["build_text_event_classification_evidence"] = _build_text_event_classification_evidence
    handlers["build_text_event_topics"] = _build_text_event_topics
    handlers["build_text_event_signals"] = _build_text_event_signals
    ...
    handlers["build_alert_decision_material"] = _build_alert_decision_material
    ...
    handlers["integrate_intelligence_fusion"] = _integrate_intelligence_fusion

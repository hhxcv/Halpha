...
* `analysis/derivatives_market_context.json` records deterministic funding, open-interest, premium, basis, and bounded liquidity-depth context states, evidence, thresholds, uncertainty, warnings, and errors, not trading signals.

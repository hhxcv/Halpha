    ...
    MuiChip: {
      styleOverrides: {
        root: {
          ...
          fontSize: 12,
          fontWeight: 700,
          "&.MuiChip-colorSuccess": { color: semanticColors.success.text },
          "&.MuiChip-outlinedSuccess": { color: semanticColors.success.text, borderColor: semanticColors.success.border },
